...
final class Version20230710191319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, photo LONGBLOB NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, infotechniques VARCHAR(255) NOT NULL, marque VARCHAR(255) NOT NULL, prix INT NOT NULL, annee INT NOT NULL, kilometrage INT NOT NULL, informationcontact VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, photo LONGBLOB DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'); //PHOTO MODIFIE EN NULL
