...
final class Version20230710211427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE horaire ADD admin_id INT NOT NULL, ADD garage_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE service ADD admin_id INT NOT NULL, ADD garage_id INT NOT NULL');
