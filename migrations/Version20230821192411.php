...
final class Version20230821192411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE horaire CHANGE admin_id admin_id INT NOT NULL, CHANGE garage_id garage_id INT NOT NULL, CHANGE heure_ouverture heure_ouverture TIME NOT NULL, CHANGE heure_fermeture heure_fermeture TIME NOT NULL, CHANGE ouverture_soir ouverture_soir TIME NOT NULL, CHANGE fermeture_soir fermeture_soir TIME NOT NULL');
        $this->addSql('ALTER TABLE temoignage CHANGE garage_id garage_id INT NOT NULL, CHANGE note note INT NOT NULL, CHANGE jourpublication jourpublication DATE NOT NULL');
    }
