...
final class Version20230807201337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin ADD email VARCHAR(255) NOT NULL, ADD password VARCHAR(255) NOT NULL, DROP email, DROP password');
        $this->addSql('ALTER TABLE employe ADD email VARCHAR(255) NOT NULL, ADD password VARCHAR(255) NOT NULL, DROP email, DROP password');
