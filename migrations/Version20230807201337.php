...
final class Version20230807201337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin ADD email VARCHAR(255) NOT NULL, ADD password VARCHAR(255) NOT NULL, DROP mail, DROP password');
        $this->addSql('ALTER TABLE employe ADD email VARCHAR(255) NOT NULL, ADD password VARCHAR(255) NOT NULL, DROP mail, DROP password');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin ADD mail VARCHAR(255) NOT NULL, ADD motdepasse VARCHAR(255) NOT NULL, DROP mail, DROP password');
        $this->addSql('ALTER TABLE employe ADD mail VARCHAR(255) NOT NULL, ADD motdepasse VARCHAR(255) NOT NULL, DROP mail, DROP password');
        $this->addSql('ALTER TABLE horaire CHANGE admin_id admin_id INT DEFAULT NULL, CHANGE garage_id garage_id INT DEFAULT NULL, CHANGE heure_ouverture heure_ouverture TIME DEFAULT NULL, CHANGE heure_fermeture heure_fermeture TIME DEFAULT NULL, CHANGE ouverture_soir ouverture_soir TIME DEFAULT NULL, CHANGE fermeture_soir fermeture_soir TIME DEFAULT NULL');
